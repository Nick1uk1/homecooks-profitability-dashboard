...
def get_manual_gopuff_orders() -> List[dict]:
    ...
    return [
        ...
        },
        {
            'store': 'Go Puff (chilled)',
            'ref': 'MANUAL-GP-006',
            'processed': '2026-03-11',  # March 2026
            'num_items': 1,
            'qty': 864,  # 864 cases (£22,044 / £25.50 per case)
            'total': 22044.00,
            'skus': 'Various',
        },
        {
        ...
        },
        {
            ...
            'ref': 'INV-0904',
            'processed': '2026-05-22',  # May 2026 — PO 0109536
            'num_items': 3,
            'qty': 181,  # cases: 35 Burrito + 47 Quesadilla + 99 Sweet Potato Hash
            'total': 3772.44,
        ...
        },
        {
            'store': 'Modern Milkman',
            'ref': 'INV-0905',
            'processed': '2026-05-23',  # May 2026 — PO O110914
            'num_items': 3,
            'qty': 206,  # cases: 52 Burrito + 86 Quesadilla + 68 Sweet Potato Hash
            'total': 4430.88,
            'skus': 'Breakfast Burrito, Quesadilla, Sweet Potato Hash',
        },
        {
            'store': 'Modern Milkman',
            'ref': 'INV-0906',
            'processed': '2026-05-28',  # May 2026 — Order 3
            'num_items': 3,
            'qty': 244,  # cases: 84 Burrito + 76 Quesadilla + 84 Sweet Potato Hash
            'total': 5300.64,
            'skus': 'Breakfast Burrito, Quesadilla, Sweet Potato Hash',
        },
        {
        ...
        },
        {
            'store': 'Modern Milkman',
            'ref': 'INV-0908',
            'processed': '2026-06-03',  # Jun 2026 — PO 11496
            'num_items': 3,
            'qty': 213,  # cases: 71 Burrito + 70 Quesadilla + 72 Sweet Potato Hash
            'total': 4624.02,
            'skus': 'Breakfast Burrito, Quesadilla, Sweet Potato Hash',
        },
        {
            'store': 'Modern Milkman',
            'ref': 'INV-0909',
            'processed': '2026-06-06',  # Jun 2026 — PO 111602
            'num_items': 3,
            'qty': 252,  # cases: 84 Burrito + 84 Quesadilla + 84 Sweet Potato Hash
        ...
        },
        {
            'store': 'Modern Milkman',
            'ref': 'INV-0910',
            'processed': '2026-06-10',  # Jun 2026 — PO-111813
            'num_items': 3,
            'qty': 250,  # cases: 82 Burrito + 84 Quesadilla + 84 Sweet Potato Hash
            'total': 5424.84,  # 82×£24.30 + 84×£21.60 + 84×£19.26
            'skus': 'Breakfast Burrito, Quesadilla, Sweet Potato Hash',
        },
        {
            'store': 'Modern Milkman',
            'ref': 'INV-0911',
            'processed': '2026-06-13',  # Jun 2026 — PO-111914
            'num_items': 3,
            'qty': 252,  # cases: 84 Burrito + 84 Quesadilla + 84 Sweet Potato Hash
            'total': 5473.44,  # 84×£24.30 + 84×£21.60 + 84×£19.26
            'skus': 'Breakfast Burrito, Quesadilla, Sweet Potato Hash',
        ...
        },
        {
            'store': 'Modern Milkman',
            'ref': 'INV-0913',
            'processed': '2026-06-20',  # Jun 2026 — Ref 112226
            'num_items': 3,
            'qty': 241,  # cases: 84 Burrito + 73 Quesadilla + 84 Sweet Potato Hash
        ...
        # --- May 2026 Default-postal mis-classifications (processed manually) ---
        {
            ...
            'ref': 'RP-20260518-B8881942',
            'processed': '2026-05-18',
            'num_items': 10,
            'qty': 15,
            'total': 351.0,
            'skus': 'A00729., A00731., A00735., A00737., A00738., A00739., A00740., A00741., A00742., A00743.',
        },
        {
            'store': 'Lincolnshire Co-operative Ltd - Woodhall Drive 001059',
            'ref': 'RP-20260518-A1911108',
            'processed': '2026-05-18',
            'num_items': 11,
            'qty': 14,
            'total': 327.6,
            'skus': 'A00729., A00731., A00734., A00735., A00737., A00738., A00739., A00740., A00741., A00742., A00743.',
        },
        {
            'store': 'Lincolnshire Co-operative Ltd - Burton Road',
            'ref': 'RP-20260511-D7459B88',
            'processed': '2026-05-18',
            'num_items': 11,
            'qty': 11,
            'total': 257.4,
        ...
        {
            'store': 'Lincolnshire Co-operative Ltd - Springfield Road 001373',
            'ref': 'RP-20260511-73474548',
            'processed': '2026-05-18',
            'num_items': 11,
            'qty': 12,
            'total': 280.8,
        ...
        {
            'store': 'Budgens, St Albans',
            'ref': 'RP-20260511-76693F27',
            'processed': '2026-05-19',
            'num_items': 7,
            'qty': 11,
            'total': 257.4,
            'skus': 'A00729., A00731., A00737., A00738., A00739., A00740., A00742.',
        },
        {
            'store': 'Connect - Formula 1',
            'ref': 'RP-20260514-3D59FED2',
            'processed': '2026-05-20',
            'num_items': 6,
            'qty': 11,
            'total': 250.8,
            'skus': 'A00729., A00734., A00737., A00738., A00739., A00742.',
        },
        {
            'store': "Jay's Budgens, Brockley",
            'ref': 'RP-20260518-6604B785',
            'processed': '2026-05-20',
            'num_items': 8,
            'qty': 14,
            'total': 327.6,
            'skus': 'A00731., A00734., A00735., A00737., A00738., A00741., A00742., A00743.',
        },
        {
            'store': 'Connect Head Office',
            'ref': 'RP-20260512-6786E136',
            'processed': '2026-05-25',
            'num_items': 9,
            'qty': 60,
            'total': 1368.0,
            'skus': 'A00729., A00731., A00734., A00735., A00737., A00739., A00740., A00741., A00742.',
        },
        {
            'store': 'Budgens, Frilford',
            'ref': 'RP-20260519-83598E87',
            'processed': '2026-05-26',
            'num_items': 7,
            'qty': 11,
            'total': 257.4,
            'skus': 'A00729., A00737., A00738., A00739., A00740., A00741., A00743.',
        },
        {
            'store': 'Budgens, Kavanaghs Hinchley Wood',
            'ref': 'RP-20260520-8065AC13',
            'processed': '2026-05-27',
            'num_items': 8,
            'qty': 13,
            'total': 304.2,
            'skus': 'A00731., A00734., A00737., A00739., A00740., A00741., A00742., A00743.',
        },
        {
            'store': 'Connect - Formula 1',
            'ref': 'RP-20260521-3D59FED2',
            'processed': '2026-05-27',
            'num_items': 6,
            'qty': 11,
            'total': 250.8,
        ...
        {
            'store': 'Lincolnshire Co-operative Ltd - Haxey 001330',
            'ref': 'RP-20260525-2EF511AE',
            'processed': '2026-05-28',
            'num_items': 10,
            'qty': 12,
            'total': 280.8,
            'skus': 'A00729., A00731., A00734., A00737., A00738., A00739., A00740., A00741., A00742., A00743.',
        },
        {
            'store': 'Lincolnshire Co-operative Ltd - Wragby 001354',
            'ref': 'RP-20260525-8FC55955',
            'processed': '2026-05-28',
            'num_items': 11,
            'qty': 22,
            'total': 514.8,
        ...
        {
            'store': 'Lincolnshire Co-operative Ltd – Market Rasen 001016.',
            'ref': 'RP-20260518-EC5F1286',
            'processed': '2026-05-28',
            'num_items': 6,
            'qty': 12,
            'total': 280.8,
            'skus': 'A00729., A00731., A00739., A00740., A00742., A00743.',
        },
        {
            'store': 'Tates of Sussex',
            'ref': 'RP-20260525-CDADC355',
            'processed': '2026-05-28',
            'num_items': 9,
            'qty': 11,
            'total': 257.4,
            'skus': 'A00729., A00734., A00735., A00737., A00738., A00739., A00740., A00741., A00742.',
        },
        {
            'store': 'Tates Texaco (Morrisons)',
            'ref': 'RP-20260521-AEC6E76A',
            'processed': '2026-05-28',
            'num_items': 6,
            'qty': 11,
            'total': 257.4,
            'skus': 'A00734., A00735., A00737., A00738., A00739., A00740.',
        },
    ]
...
<p style="color:{HC_LIGHT_MINT}; font-size:0.75em; margin:15px 0 0 0; border-top:1px solid rgba(255,255,255,0.2); padding-top:10px;">AOV: {format_currency(row['aov'])} &nbsp;|&nbsp; Avg COGS: {format_currency(row['avg_cogs'])} &nbsp;|&nbsp; Discounts: {format_currency(row['discounts'])}</p>
        ...
        display_cols = [
            ...
            "gross_item_value", "total_discounts", "net_revenue_total",
            "shipping_paid", "cogs", "avg_cogs", "packaging_total",
        ...
        disp_df.columns = [
            ...
            "Ship Paid", "COGS", "Avg COGS", "Packaging",
            "Contribution", "Margin %"
        ]
